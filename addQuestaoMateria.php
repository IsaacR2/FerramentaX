...
<body>
	...
	<div class="container" align="center">
		<h2>Cadastro de Materia da Questão</h2>
		<form name="form1" action="proc/proc_addQuestaoMateria.php" method="POST" id="IdForm1">
			<div class="col-md-4 col-md-offset-4">
				<label for="usr">Materia:</label>
				<select name="NMateria" class="form-control">
					<?php foreach ($materia as $linha): ?>
						<option value="<?php echo $linha['id'] ?>"><?php echo $linha['nome_materia'] ?></option>	
					<?php endforeach; ?>
				</select>
			</div>
			<br><br><br><br>
